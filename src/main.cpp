...
uint256 hashGenesisBlock("0x1d7873d71d87f7d5b9bbe5a1baa2828bf5d1a2d23584ff85200d05b9764c215e");
...
const string strMessageMagic = "skint Signed Message:\n";
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal skint miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "skint", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xbb1f5264efce55765b7292a392f74bb19fc167f4bbfe7b8145daab7b50515df2");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "Ukrainians stage symbolic protest at opening of Sochi Winter Paralympics";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1394227743; 
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085696463;

        if (fTestNet)
        {
            block.nTime    = 1394058624;
            block.nNonce   = 386929957;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xbf341f621a551c2931c0d1fd855643cb7b362e77c8d0a25e5cbecfc62c28b6d0"));
        ...
        block.print();
        assert(true && block.GetHash() == hashGenesisBlock);
